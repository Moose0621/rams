...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'zipcode', 'error')} required">
	...
	<g:textField name="zipcode" pattern="${userInstance.constraints.zipcode.matches}" required="" value="${userInstance?.zipcode}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'state', 'error')} required">
	...
	<g:textField name="state" pattern="${userInstance.constraints.state.matches}" required="" value="${userInstance?.state}"/>
</div>
